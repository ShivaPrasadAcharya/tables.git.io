const tableData = [
    ...
    title: "Comparision between CiLS & CoLS",
    caption: "Judicial Administration in CiLS & CoLS",
    table: [
        ["CN7: Here's a comparative table between Civil Law and Common Law Jurisdictions:"],
        [""],
        ["<b><u>१. संरचनात्मक पक्षहरू (Structural Aspects):</b></u>"],
        ["<b>क) अदालती संरचना (Court Structure):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Hierarchical with specialized courts", "- Unified with generalist courts", ""],
        ["", "- Dual system (administrative & ordinary)", "- Single integrated system", ""],
        ["", "- Multiple specialized chambers", "- General jurisdiction chambers", ""],
        ["[Example: French Conseil d'État vs. UK Supreme Court]"],
        [""],
        ["<b><u>२. कार्यात्मक पक्षहरू (Functional Aspects):</b></u>"],
        ["<b>क) न्यायिक भूमिका (Judicial Role):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Inquisitorial approach", "- Adversarial approach", ""],
        ["", "- Active fact-finding by judges", "- Passive arbitration by judges", ""],
        ["", "- Limited precedential value", "- Strong precedential system", ""],
        ["[Example: German judge's investigative role vs. US judge's referee role]"],
        [""],
        ["<b><u>३. प्रक्रियागत पक्षहरू (Procedural Aspects):</b></u>"],
        ["<b>क) कार्यविधि (Procedure):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Written procedure dominates", "- Oral arguments emphasized", ""],
        ["", "- Multiple discontinuous hearings", "- Continuous trial process", ""],
        ["", "- Limited discovery", "- Extensive discovery rights", ""],
        ["[Example: Italian written submissions vs. English oral advocacy]"],
        [""],
        ["<b><u>४. न्यायाधीश सम्बन्धी (Judicial Aspects):</b></u>"],
        ["<b>क) नियुक्ति र तालिम (Appointment & Training):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Career judiciary", "- Appointed from practitioners", ""],
        ["", "- Specialized training schools", "- Limited formal training", ""],
        ["", "- Direct entry after law school", "- Experience-based selection", ""],
        ["[Example: French ENM vs. US Federal judicial appointments]"],
        [""],
        ["<b><u>५. प्रमाण सम्बन्धी (Evidentiary Aspects):</b></u>"],
        ["<b>क) प्रमाण व्यवस्थापन (Evidence Management):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Free evaluation of evidence", "- Strict rules of evidence", ""],
        ["", "- Court-appointed experts", "- Party-appointed experts", ""],
        ["", "- No cross-examination", "- Extensive cross-examination", ""],
        ["[Example: Swedish free proof system vs. Australian evidence rules]"],
        [""],
        ["<b><u>६. फैसला सम्बन्धी (Judgment Aspects):</b></u>"],
        ["<b>क) निर्णय लेखन (Decision Writing):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Concise, formal style", "- Detailed reasoning", ""],
        ["", "- No dissenting opinions", "- Dissenting opinions common", ""],
        ["", "- Syllogistic reasoning", "- Precedent-based reasoning", ""],
        ["[Example: French Court of Cassation vs. Indian Supreme Court judgments]"],
        [""],
        ["<b><u>७. प्रशासनिक पक्षहरू (Administrative Aspects):</b></u>"],
        ["<b>क) अदालत व्यवस्थापन (Court Management):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Centralized administration", "- Independent administration", ""],
        ["", "- Ministry oversight", "- Judicial control", ""],
        ["", "- Professional managers", "- Court executive services", ""],
        ["[Example: Dutch Council for Judiciary vs. Canadian Court Administration]"],
        [""],
        ["<b><u>८. कानूनी स्रोतहरू (Legal Sources):</b></u>"],
        ["<b>क) प्राथमिक स्रोत (Primary Sources):</b>"],
        [""],
        ["", "Civil Law", "Common Law", ""],
        ["", "-----------", "------------", ""],
        ["", "- Codified laws primary", "- Case law primary", ""],
        ["", "- Academic writings influential", "- Statutory interpretation key", ""],
        ["", "- Systematic interpretation", "- Pragmatic reasoning", ""],
        ["[Example: German Civil Code vs. English common law principles]"]
    ],
    footnote: "Compiled by:Shiva Prasad Acharya (2081)",
